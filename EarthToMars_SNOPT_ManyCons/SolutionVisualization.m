...
file3='../EarthToMars_SNOPT_ManyCons/ThrustRunTime.txt';
fid3 = fopen(file3, 'w');
...
% Load GMAT SCRIPT
gmat.gmat.LoadScript("C:/GMAT_Repo/EarthToMars_SNOPT_ManyCons/GMATScriptEarthMarsPlots.script");
...
%READ Data File
file1='../EarthToMars_SNOPT_ManyCons/DataOutput.txt';
fID1=fopen(file1,'r');
