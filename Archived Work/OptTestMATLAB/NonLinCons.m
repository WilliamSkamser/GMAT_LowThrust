...
%Now add Magnitude constraints here....   
M=zeros(10,1);
for i=1:10
    M(i) =11.75 - norm([ThrustProfileNew(i,2) ThrustProfileNew(i,3) ThrustProfileNew(i,4)]);
end
...
%Rmag(1)=42163-Data(2); 
%Rmag(2)=42165-Data(2);
%add inquality constraints for radius of earth (prevent trjectory from
...
%Latitude=Data(5);
Cons_eq=[e Rmag_eq Inc_eq Longitude M(1) M(2) M(3) M(4) M(5) M(6) M(7) M(8) M(9) M(10)];
end 